...
MIN_RESOLVED_BEFORE_WEIGHTS = 3       # require real evidence before weights
BURN_UID = 36                         # receives reserved burn allocation
BURN_PERCENTAGE = 0.96                # burn 96%, distribute 4% to scored miners
